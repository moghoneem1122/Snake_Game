#define RAYLIB_BUILD_LIBTYPE_SHARED
#define RAYLIB_WINDOWS
...
public:
    ...
    {
        Image image = LoadImage("C:/Users/East-Sound/Downloads/food.png");
...
int main()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawText("Ghoneem Snake", offset - 5, 20, 40, darkGreen);
